    ...
    */ 
        ...
        function contactForm(){
            ...
            $('form').submit(function(evt){
                ...
                if(userTitle.val().length < 6){
                    // Afficher un msg d'erreur
                    $('[for="userTitle"] b').text('Minimum 6 caractères');
                ...
                if(userContent.val().length < 6){
                    // Afficher un msg d'erreur
                    $('[for="userContent"] b').text('Minimum 6 caractères');
                ...
                if(formScore == 6){
                    ...
                    var param = 'name='+userName.val()+'&email='+userEmail.val()+'&subject='+userSubject.val()+'&message='+userMessage.val()+'&title='+userTitle.val()+'&content='+userContent.val();
